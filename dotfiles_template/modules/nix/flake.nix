  ...
  let
    ...
    configuration = { pkgs, ... }: {
      ...
      environment.systemPackages = with pkgs; [
        ...
        fzf
        zsh
      ] ++ nixpkgs.lib.optional nixpkgs.config.programs.zsh.enableCompletion pkgs.nix-zsh-completions
        ++ nixpkgs.lib.optional nixpkgs.config.programs.zsh.enableSyntaxHighlighting pkgs.zsh-syntax-highlighting
        ++ nixpkgs.lib.optional nixpkgs.config.programs.zsh.enableFastSyntaxHighlighting pkgs.zsh-fast-syntax-highlighting;
