...
export NIX_CONFIG_HOME="$HOME/.config/nix-darwin"
...
NIX_CONFIG_HOME: $NIX_CONFIG_HOME
ZIM_HOME: $ZIM_HOME
"
...
sed -i -e "s|XXX_USER_DOTFILES_PATH_XXX|$DOTFILES_PATH|g" "./bin/sdot"
sed -i -e "s|XXX_USER_DOTFILES_PATH_XXX|$DOTFILES_PATH|g" "./shell/bash/.bashrc"
sed -i -e "s|XXX_USER_DOTFILES_PATH_XXX|$DOTFILES_PATH|g" "./shell/zsh/.zshenv"
"$DOTLYX_HOME_PATH/modules/dotbot/bin/dotbot" -d "$DOTLYX_HOME_PATH" -c "./symlinks/conf.yaml"
